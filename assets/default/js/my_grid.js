    ...
    function load_data(url) {
        ...
        $.ajax({
            ...
            success: function(msg) {
                ...
                $('.hapus').click(function() {
                    ...
                    if (confirm('Are You sure want to delete this records?')) {
                        $.ajax({
                            ...
                            data: 'iddel=' + idx+'&data_redirect ='+data_recirect,
                            type: 'POST',
                            success: function(msg) {
                ...
                $('.is_broadcast').change(function() {
                    
                    var idx = $(this).attr('data-id');
                    var link = $(this).attr('data-url-rm');
                    var status_broad_cast =  $(this).val();
                    var data_recirect = $(this).attr('data-redirect');
                   // alert(langs);
                    if (confirm('Are You sure want to change this record?')) {
                        $.ajax({
                            url: current_ctrl + link,
                            data: 'iddel=' + idx+'&status_broadcast='+status_broad_cast,
                            type: 'POST',
                            success: function(msg) {
                                my_grid(order_id);
                                //alert(msg);
