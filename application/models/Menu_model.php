...
class Menu_model extends CI_Model
{
    ...
    function GetMenu($id)
    {
        ...
        $data['listFunction'] = [];
        if($data){
            $listFunction = $this->db->where('menu_id',$id)->get('auth_menu_function')->result_array();
            $data['listFunctionDetail'] = $listFunction;
        }
    ...
    function DeleteFunctionWhereIn($table,$where_in)
    {
        $this->db->where_in('id_auth_menu_function',$where_in);
        $this->db->delete($table);
        #$this->db->delete(['auth_menu_function', 'auth_function_group']);
    }
