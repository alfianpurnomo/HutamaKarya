...
class Department_model extends CI_Model
{
    ...
    function GetDepartment($id)
    {
        $data = $this->db
                ...
                ->where('a.id_master_department', $id)
                ->limit(1)
    ...
    {
        $this->db->insert('master_department', $param);
     ...
     */
    function checkExistsDepartmentName($email, $id = 0)
    {
        if ($id != '' && $id != 0) {
