...
|
*/
$config['base_url'] = $config['base_url']	= $_SERVER['HTTP_HOST'].'/EPM';
...
$config['sess_save_path']          = 'xms_sessions';
...
$config['csrf_exclude_uris'] = array('login','logout','performance/ajax_map_bts_status_ti_search','master_data/add_master_simcard');
