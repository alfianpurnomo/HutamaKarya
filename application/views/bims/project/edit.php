                ...
                <?php echo form_open($form_action, 'id="form-project" role="form" enctype="multipart/form-data"'); ?>
                    <div class="row">
                        <div class="col-lg-6 col-md-6  col-xs-12">
                            ...
                            <div class="form-group" <?php echo (isset($post['is_default']) && !empty($post['is_default'])) ? 'style="display: none;"' : ''; ?> id="employee_list">
                                ...
                                <div class="wrap-employee">
                                    ...
                                    ?>
                                        <div id="list-employee-<?php echo $key+1;?>" class="list-employee">
                                            <div class="item-pekerja ">
                                                <div class="col" style="width: 204px;">
                                                    <label><?php echo $value['nik']?> - <?php echo $value['firstname']?> <?php echo $value['lastname']?></label>
                                                    <input type="hidden" value="<?php echo $value['employeeid'] ?>" name="listEmployee[<?php echo $key;?>][employeeid]"> </div>
                                                <div class="col" >
                                                    <label>Role</label>
                                                    <select class="form-control selectRole_edit" id="employee_role<?php echo $key;?>" name="listEmployee[<?php echo $key;?>][employee_role]">
                                                    <option>Choose Role</option>
                                                    <?php
                                                    foreach ($dataRole as $key1 => $value1) {
                                                    ?>
                                                        <option <?php echo ($value['employee_role']==$value1['id_master_role_tasks']) ? 'selected="selected"' : '' ?> value="<?php echo $value1['id_master_role_tasks']?>">
                                                ...
                                                <div class="col">
                                                    ...
                                                    <div class="input-group date">
                                                        <input readonly type="text" id="start_date<?php echo $key;?>" name="listEmployee[<?php echo $key;?>][start_date]" class="form-control date-pickere" data-autoclose="1" value="<?php echo $value['start_date'] ?>" placeholder="Select Date">
                                                        <div class="input-group-addon"> <span class="sli-calendar"></span> </div>
                                                    </div>
                                                </div>
                                                <div class="col">
                                                    <label>End Date</label>
                                                    <div class="input-group date">
                                                        <input readonly type="text" id="end_date<?php echo $key;?>" name="listEmployee[<?php echo $key;?>][end_date]" class="form-control date-pickere" data-autoclose="1" value="<?php echo $value['end_date'] ?>" placeholder="Select Date">
                                                        <div class="input-group-addon"> <span class="sli-calendar"></span> </div>
                                                    </div>
                                                </div>
                                                <div class="col close-employee"> <span class="deleteEmployee" data-wrap="list-employee-<?php echo $key+1;?>">x</span> </div>
                                            </div>
                                        </div>
                        ...
                        <div class="col-lg-4 col-md-4  col-xs-12 col-lg-offset-1">
                            <div class="form-group">
                                ...
                                <div class="input-group date" >
                                    <input type="text" name="start_date" id="start_date" class="form-control" data-autoclose="1" value="<?php echo (isset($post['start_date'])) ? $post['start_date'] : date('Y-m-d'); ?>" placeholder="Select Date">
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group date" >
                                    <input type="text" name="end_date" id="end_date" class="form-control" data-autoclose="1" value="<?php echo (isset($post['end_date'])) ? $post['end_date'] : date('Y-m-d'); ?>" placeholder="Select Date">
                                    <div class="input-group-addon">
                                        <span class="sli-calendar"></span>
                                    </div>
                                </div>
                            ...
                            <div class="form-group" <?php echo (isset($post['is_started']) && !empty($post['is_started'])) ? '' : 'style="display: none;"'; ?> id="wrap_started_date">
...
<script type="text/javascript">
        ...
        var html = '<div id="'+div_id+'" class="list-employee">\
                        <div class="item-pekerja ">\
                            ...
                            <div class="col">\
                                <label>Start Date</label>\
                                <div class="input-group date" >\
                                    <input type="text" id="start_date'+row+'" name="listEmployee['+row+'][start_date]" class="form-control date-pickers" data-autoclose="1" value="<?php echo date('Y-m-d'); ?>" placeholder="Select Date">\
                                    <div class="input-group-addon">\
                                        <span class="sli-calendar"></span>\
                                    </div>\
                                </div>\
                            ...
                            <div class="col">\
                                <label>End Date</label>\
                                <div class="input-group date" >\
                                    <input type="text" id="end_date'+row+'" name="listEmployee['+row+'][end_date]" class="form-control date-pickers" data-autoclose="1" value="<?php echo date('Y-m-d'); ?>" placeholder="Select Date">\
                                    <div class="input-group-addon">\
                                        <span class="sli-calendar"></span>\
                                    </div>\
                                </div>\
    ...
    $(document).ready(function(){
        ...
        $('#start_date').change(function(){
          ...
          if(start_date != ''){
           $('#end_date,.date-pickere,.date-pickers,#started_date').datepicker('setStartDate', new Date(start_date));
          }
        ...
        $('#end_date').change(function(){
          ...
          // Set minDate and maxDate
          if(end_date != ''){
           $('.date-pickere,.date-pickers').datepicker('setEndDate', new Date(end_date));
           $('#started_date').datepicker('setEndDate', new Date(end_date));
          }
